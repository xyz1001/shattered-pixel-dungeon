...
public enum DictionaryJournal {
    ...
    static {
        ...
        ARTIFACTS.d.put("artifact_skeleton_key",    ItemSpriteSheet.ARTIFACT_KEY);
...
//        ALCHEMY.d.put("bomb_shocking",      ItemSpriteSheet.SHOCK_BOMB);
        ...
        WEAPONS.d.put("missile_set",        ItemSpriteSheet.JAVELIN);
        ...
        TRINKETS.d.put("trinket_cracked_spyglass",ItemSpriteSheet.SPYGLASS);
